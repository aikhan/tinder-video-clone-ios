...
from streaming.exceptions import BadStatusCodeError
from streaming.exceptions import RequestError
from streaming.exceptions import RetryAfterError
from streaming.util import calculate_wait_for_retry
...
def _check_response(response):
    ...
    :raises: :exc:`streaming.exceptions.RequestError` if response
...
def _make_api_request_no_retry(http, http_request, redirections=_REDIRECTIONS):
    ...
    :raises: :exc:`streaming.exceptions.RequestError` if no
